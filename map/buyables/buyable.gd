...
const COIN_SFX: Array[AudioStream] = [preload("res://map/buyables/sfx/coin1.ogg"), preload("res://map/buyables/sfx/coin2.ogg"), preload("res://map/buyables/sfx/coin3.ogg"), preload("res://map/buyables/sfx/coin4.ogg"), preload("res://map/buyables/sfx/coin5.ogg"), preload("res://map/buyables/sfx/coin6.ogg"), preload("res://map/buyables/sfx/coin7.ogg")]
